...
public class SettingsActivity extends PreferenceActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_autoplay_next_key)));
    }
    ...
    private void bindPreferenceSummaryToValue(Preference preference) {
        ...
        android.content.SharedPreferences defaultSharedPrefs = PreferenceManager.getDefaultSharedPreferences(preference.getContext());
        Object defaultValue = null;
        try {
            defaultValue = defaultSharedPrefs.getString(preference.getKey(), "");
